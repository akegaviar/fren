...
var serverUrl = "https://hpz4yq50hr8y.usemoralis.com:2053/server";
var appId = "FaLY0U96izeaTHPkmvxHUq87YIejSYU0KMBiHS5M";
Moralis.start({
  serverUrl: serverUrl,
  appId: appId
});
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return Moralis.authenticate({
              ...
              document.getElementById("myethAddress").textContent = "Logged in Eth Address ".concat(ethAddress);
          ...
          case 7:
            ...
            document.getElementById("myethAddress").textContent = "Already Logged in ".concat(ethAddress);
